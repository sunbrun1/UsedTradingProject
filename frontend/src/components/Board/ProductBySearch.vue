            ...
            <div class="bysearch_wrap">
                ...
                <div class="paging">
                    <ul>
                        <!-- 이전 버튼 -->
                        <ul>
                            <router-link :to="{ path: '/bySearch/list', query: { no: (startPageIndex - 1) * listRowCount, categoryLargeId: $route.query.categoryLargeId, categoryMediumId: $route.query.categoryMediumId, search: search}}" @click.native="movePage(endPageIndex - 1)">
                        ...
                        <ul v-for="index in endPageIndex-startPageIndex + 1 " :key="index">
                            <router-link :to="{ path: '/bySearch/list', query: { no: (startPageIndex+index) -1, categoryLargeId: $route.query.categoryLargeId, categoryMediumId: $route.query.categoryMediumId, search: search   }}">
                                <li class="page-item">    
                        ...
                        <!-- 다음버튼 -->
                        <ul>
                            <router-link :to="{ path: '/bySearch/list', query: { no: (endPageIndex + 1) * listRowCount, categoryLargeId: $route.query.categoryLargeId, categoryMediumId: $route.query.categoryMediumId, search: search}}" @click.native="movePage(endPageIndex + 1)">
...
export default {
	...
	methods:{
        ...
        async getProductList() {
			const res = await axios.get("http://localhost:3000/api/board/bysearch/list",{
                params: {
            ...
            this.search = this.$route.query.search; // 검색 정보
            /* 상품등록 시간 */
        ...
        /* 페이징 */
        async bySearchCount(){
            const res = await axios.get("http://localhost:3000/api/paging/bysearch",{
                params: {
                    categoryLargeId : this.$route.query.categoryLargeId,
                    search : this.$route.query.search,
                }
